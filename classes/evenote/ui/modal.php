...
class modal extends panel {
	...
	public function is_submitted() {
		...
		return isset( $data[ 'evenoteNonce_' . $this->id() ] ) && wp_verify_nonce( $data[ 'evenoteNonce_' . $this->id() ], $this->id() );
	}
	...
	public function set_assets() {
		...
		$this->assets['script']['modals'] = array(
			'src'  => $this->url . 'assets/js/modals' . EVENT_NOTIFY_ASSET_DEBUG . '.js',
			'deps' => array( 'baldrick' ),
		);
		$this->assets['style']['modals']  = $this->url . 'assets/css/modals' . EVENT_NOTIFY_ASSET_DEBUG . '.css';
