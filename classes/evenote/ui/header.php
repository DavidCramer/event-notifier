...
class header extends section {
	 ...
	 * @var array
	 */
	public $attributes = array( 'class' => 'evenote-title' );
	...
	public function label() {
		...
		if ( ! empty( $this->struct['label'] ) ) {
			$output .= '<span class="evenote-text">' . esc_html( $this->struct['label'] ) . '</span>';
		}
	...
	public function set_assets() {
		...
		$this->assets['style']['header'] = $this->url . 'assets/css/header' . EVENT_NOTIFY_ASSET_DEBUG . '.css';
